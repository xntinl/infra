...
Continue to [08-block-hostpath](../08-block-hostpath/08-block-hostpath.md) to write a policy that iterates over volumes and checks for the existence of a type-specific field.
