...
You have the basic Gatekeeper pattern: extract Rego, simulate the input, test locally. Continue to [04-block-default-ns](../04-block-default-ns/04-block-default-ns.md) to apply this pattern to a governance policy on a different resource field.
