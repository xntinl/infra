...
Continue to [02-concepts](../02-concepts/02-concepts.md) to learn about Gatekeeper's operational features: failure policies, enforcement actions, match scoping, and more.
