...
Continue to [09-block-wildcard-ingress](../09-block-wildcard-ingress/09-block-wildcard-ingress.md) to write a policy for Ingress resources -- combining string comparison with field absence detection.
