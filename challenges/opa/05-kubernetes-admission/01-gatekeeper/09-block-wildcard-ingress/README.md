...
|----------|----------|-------------|
| [03-first-policy](../03-first-policy/) | Any | Iteration over parameters, `not` for missing labels |
| [04-block-default-ns](../04-block-default-ns/) | Any | Simple field comparison on metadata |
| [05-block-nodeport](../05-block-nodeport/) | Service | Field comparison on spec |
| [06-block-host-ns](../06-block-host-ns/) | Pod | Multiple rules, explicit `== true` for booleans |
| [07-require-probes](../07-require-probes/) | Pod | Iteration over containers, `not` for nested fields |
| [08-block-hostpath](../08-block-hostpath/) | Pod | Iteration over volumes, field existence as type check |
| [09-block-wildcard-ingress](../09-block-wildcard-ingress/) | Ingress | String comparison + field absence detection |

## What's Next

Return to the [main section](../../) to continue with the deeper exercises:
