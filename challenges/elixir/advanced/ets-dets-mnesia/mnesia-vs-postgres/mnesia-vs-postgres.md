...
defmodule MnesiaVsPostgres.MixProject do
  ...
  def project do
    [app: :mnesia_vs_postgres, version: "0.1.0", elixir: "~> 1.19", deps: deps()]
  end
...
```
### `lib/mnesia_vs_postgres.ex`

```elixir
defmodule MnesiaVsPostgres do
  @moduledoc """
  Mnesia vs Postgres — Honest Comparison and Benchmark.

  Postgres is the right answer for most workloads. Mnesia wins specifically when the dataset fits in cluster RAM, latency matters, and the team owns the BEAM cluster. Outside that....
  """
end
```
### `lib/mnesia_vs_postgres/store_behaviour.ex`
...
```
### `lib/mnesia_vs_postgres/mnesia_store.ex`
...
```
### `lib/mnesia_vs_postgres/repo.ex`
...
```
### `lib/mnesia_vs_postgres/postgres_store.ex`
...
```
### `lib/mnesia_vs_postgres/application.ex`
...
config :mnesia_vs_postgres, MnesiaVsPostgres.Repo,
  ...
  pool_size: 10
```
### `test/mnesia_vs_postgres_test.exs`
...
## Why Mnesia vs Postgres — Honest Comparison and Benchmark matters

Mastering **Mnesia vs Postgres — Honest Comparison and Benchmark** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
