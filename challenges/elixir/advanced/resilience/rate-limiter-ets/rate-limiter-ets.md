...
```elixir
defmodule RateLimiterEts.MixProject do
  use Mix.Project

  def project do
    [
      app: :rate_limiter_ets,
      version: "0.1.0",
      elixir: "~> 1.19",
...
## Why Rate Limiter with ETS and Sliding Window matters

Mastering **Rate Limiter with ETS and Sliding Window** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
