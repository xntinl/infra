...
### `test/liveview_realtime_test.exs`
...
## Why Phoenix LiveView — Real-Time Updates with PubSub matters

Mastering **Phoenix LiveView — Real-Time Updates with PubSub** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.

Understanding the underlying semantics (not just the syntax) is what separates engineers who can debug a cascading failure at 3 AM from those who can only write new code. This document focuses on the *why*: memory layout, process boundaries, failure semantics, and the trade-offs you are implicitly accepting when you choose one approach over another.

Invest the time here. The compound interest on fundamental concepts is enormous.

### `lib/liveview_realtime.ex`

```elixir
defmodule LiveviewRealtime do
  @moduledoc """
  Reference implementation for Phoenix LiveView — Real-Time Updates with PubSub.
  ...
  @doc """
  Entry point for the liveview_realtime module. Replace the body with the real
  implementation once you have worked through the exercise.

  ## Examples

      iex> LiveviewRealtime.run(:noop)
      :ok
...
### `mix.exs`
```elixir
defmodule PhoenixLiveviewRealTime.MixProject do
  use Mix.Project

  def project do
    [
      app: :phoenix_liveview_real_time,
      version: "0.1.0",
      elixir: "~> 1.19",
