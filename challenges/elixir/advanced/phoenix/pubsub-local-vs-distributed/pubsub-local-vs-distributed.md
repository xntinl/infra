...
defmodule EventsBus.MixProject do
  use Mix.Project
  def project, do: [app: :events_bus, version: "0.1.0", elixir: "~> 1.19", deps: deps()]
...
### `mix.exs`
```elixir
defmodule PubsubLocalVsDistributed.MixProject do
  use Mix.Project

  def project do
    [
      app: :pubsub_local_vs_distributed,
      version: "0.1.0",
      elixir: "~> 1.19",
...
## Why Phoenix.PubSub Local vs Distributed (` matters

Mastering **Phoenix.PubSub Local vs Distributed (`** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
...
```elixir
defmodule EventsBus do
  @moduledoc """
  Reference implementation for Phoenix.PubSub Local vs Distributed (`:pg` adapter).
  ...
  @doc """
  Entry point for the events_bus module. Replace the body with the real
  implementation once you have worked through the exercise.

  ## Examples

      iex> EventsBus.run(:noop)
      :ok
...
### `test/events_bus_test.exs`

```elixir
defmodule EventsBusTest do
