...
defmodule MediaVault.MixProject do
  ...
  def project, do: [app: :media_vault, version: "0.1.0", elixir: "~> 1.19", deps: deps()]
...
### `mix.exs`
```elixir
defmodule LiveviewUploadsProgress.MixProject do
  use Mix.Project

  def project do
    [
      app: :liveview_uploads_progress,
      version: "0.1.0",
      elixir: "~> 1.19",
...
## Why LiveView Uploads with Progress and Chunked Consumption matters

Mastering **LiveView Uploads with Progress and Chunked Consumption** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
...
```elixir
defmodule MediaVault do
  @moduledoc """
  Reference implementation for LiveView Uploads with Progress and Chunked Consumption.
  ...
  @doc """
  Entry point for the media_vault module. Replace the body with the real
  implementation once you have worked through the exercise.

  ## Examples

      iex> MediaVault.run(:noop)
      :ok
...
```
### `test/media_vault_test.exs`

```elixir
defmodule MediaVaultTest do
  use ExUnit.Case, async: true
