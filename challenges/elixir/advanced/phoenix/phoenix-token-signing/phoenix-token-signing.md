...
defmodule ShareLinks.MixProject do
  use Mix.Project
  def project, do: [app: :share_links, version: "0.1.0", elixir: "~> 1.19", deps: deps()]
...
### `mix.exs`
```elixir
defmodule PhoenixTokenSigning.MixProject do
  use Mix.Project

  def project do
    [
      app: :phoenix_token_signing,
      version: "0.1.0",
      elixir: "~> 1.19",
...
## Why Phoenix.Token for Secure Signing and Verification matters

Mastering **Phoenix.Token for Secure Signing and Verification** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
...
```elixir
defmodule ShareLinks do
  @moduledoc """
  Reference implementation for Phoenix.Token for Secure Signing and Verification.
  ...
  @doc """
  Entry point for the share_links module. Replace the body with the real
  implementation once you have worked through the exercise.

  ## Examples

      iex> ShareLinks.run(:noop)
      :ok
...
### `test/share_links_test.exs`

```elixir
defmodule ShareLinksTest do
  use ExUnit.Case, async: true
