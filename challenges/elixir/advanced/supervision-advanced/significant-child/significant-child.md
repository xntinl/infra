...
## Why significant children and auto_shutdown (elixir 1.15+) matters
...
### `mix.exs`
```elixir
defmodule SignificantChild.MixProject do
  use Mix.Project

  def project do
    [
      app: :significant_child,
      version: "0.1.0",
      elixir: "~> 1.19",
...
```
### `test/significant_child_test.exs`
...
defmodule SignificantChild.AutoShutdownTest do
  ...
  doctest SignificantChild.Batches
...
Main.main()
```
### `lib/significant_child.ex`

```elixir
defmodule SignificantChild do
  @moduledoc """
  Reference implementation for Significant children and auto_shutdown (Elixir 1.15+).
  ...
  @doc """
  Entry point for the significant_child module. Replace the body with the real
  implementation once you have worked through the exercise.

  ## Examples

      iex> SignificantChild.run(:noop)
      :ok
