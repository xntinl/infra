...
## Why application start phases for ordered boot matters
...
### `lib/start_phases/application.ex`
...
### `lib/start_phases/telemetry_spine.ex`
...
### `lib/start_phases/lock_manager.ex`
...
### `lib/start_phases/http_endpoint.ex`
...
defmodule StartPhasesTest do
  ...
  doctest StartPhases.HttpEndpoint
...
defmodule StartPhasesTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert StartPhases.run(:noop) == :ok
    end
  end
end
```
