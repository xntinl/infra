...
```elixir
defmodule PartitionDispatcher.MixProject do
  use Mix.Project

  def project do
    [
      app: :partition_dispatcher,
      version: "0.1.0",
      elixir: "~> 1.19",
...
```
### `test/partition_dispatcher_test.exs`

```elixir
defmodule PartitionDispatcher.OrderingTest do
  use ExUnit.Case, async: true
  doctest PartitionDispatcher.BookProducer
