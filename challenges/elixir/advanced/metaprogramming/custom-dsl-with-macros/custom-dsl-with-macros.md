...
### `mix.exs`
```elixir
defmodule CustomDslWithMacros.MixProject do
  use Mix.Project

  def project do
    [
      app: :custom_dsl_with_macros,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `lib/validation_dsl/validators.ex`
...
### `lib/validation_dsl/compiler.ex`
...
## Why Custom DSL with Macros and Compile-Time Checks matters

Mastering **Custom DSL with Macros and Compile-Time Checks** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
