...
defmodule Main do
  def main do
    IO.puts("=== ValidateLib: demo ===\n")

    result_1 = Mix.env()
    IO.puts("Demo 1: #{inspect(result_1)}")

    result_2 = Regex.match?(~r/^[^@\s]+@[^@\s]+\.[^@\s]+$/, value)
