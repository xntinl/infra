...
defmodule Validator do
  ...
  @doc "Validates email result."
  def validate_email(""), do: {:error, "email is required"}

  @doc "Validates email result from email."
  ...
  @doc "Validates email result from _."
  ...
  @doc "Validates password result from password."
  ...
  @doc "Validates password result from _."
  ...
  @doc "Validates username result."
  def validate_username(""), do: {:error, "username is required"}

  @doc "Validates username result from username."
  ...
  @doc "Validates username result from _."
  ...
  @doc "Validates age result from age."
  ...
  @doc "Validates age result from _."
...
defmodule Main do
  def main do
    IO.puts("=== Validator: demo ===\n")

    result_1 = Validator.validate(%{email: "user@example.com", password: "Str0ng!Pass", username: "alice", age: 25})
    IO.puts("Demo 1: #{inspect(result_1)}")

    result_2 = Validator.validate(%{email: "bad", password: "Str0ng!Pass", username: "alice", age: 25})
    IO.puts("Demo 2: #{inspect(result_2)}")

    result_3 = Validator.validate_all(%{email: "bad", password: "short", username: "", age: -1})
...
Mastering **Control Flow** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
