...
defmodule CheckoutFlow.Checkout do
  ...
  @spec process_value(request()) :: {:ok, order()} | {:error, error_reason()}
  def process_value(%{
        cart: cart,
        stock: stock,
        coupon: coupon,
