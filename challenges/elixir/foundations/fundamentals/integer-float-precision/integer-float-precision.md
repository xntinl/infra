...
defmodule CurrencyPrecisionConverterTest do
  ...
  doctest CurrencyPrecisionConverter
...
defmodule Main do
  def main do
    IO.puts("=== CurrencyPrecisionConverter: demo ===\n")

    result_1 = CurrencyPrecisionConverter.convert(10_000, "USD", "EUR", Decimal.new("0.9234"))
    IO.puts("Demo 1: #{inspect(result_1)}")

    result_2 = CurrencyPrecisionConverter.convert(5_000, "USD", "JPY", Decimal.new("155.732"))
    IO.puts("Demo 2: #{inspect(result_2)}")

    result_3 = CurrencyPrecisionConverter.convert(1000, "JPY", "USD", Decimal.new("0.00642"))
...
## Why Integer and Float Precision matters

Mastering **Integer and Float Precision** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
