...
### `mix.exs`
```elixir
defmodule FeatureFlagEvaluator.MixProject do
  use Mix.Project

  def project do
    [
      app: :feature_flag_evaluator,
      version: "0.1.0",
      elixir: "~> 1.19",
...
defmodule Main do
  def main do
    IO.puts("=== FeatureFlagEvaluator: demo ===\n")
...
## Why Booleans, Nil and Truthiness matters

Mastering **Booleans, Nil and Truthiness** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
