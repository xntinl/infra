...
defmodule Main do
  def main do
    ...
    result_1 = Money.new(1999, :usd)
    IO.puts("Demo 1: #{inspect(result_1)}")

    result_2 = Money.from_float(19.99, :usd)
    IO.puts("Demo 2: #{inspect(result_2)}")

    result_3 = Money.from_float(0.1 + 0.2, :usd)
...
## Why Numbers and Arithmetic matters

Mastering **Numbers and Arithmetic** directly impacts how you design reliable, scalable Elixir systems. The patterns and trade-offs covered in this exercise appear in production code shipped by companies running the BEAM at scale — from payment processors to chat platforms to telemetry pipelines.
