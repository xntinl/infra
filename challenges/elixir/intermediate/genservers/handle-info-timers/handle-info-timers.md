...
## Why handle info timers matters
...
```elixir
defmodule TimerGs.MixProject do
  use Mix.Project
...
### `test/timer_gs_test.exs`

```elixir
defmodule TimerGsTest do
  use ExUnit.Case, async: true
