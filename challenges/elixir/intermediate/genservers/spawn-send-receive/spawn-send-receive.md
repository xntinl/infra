...
## Why procesos spawn send receive matters
...
```elixir
defmodule ProcessPrimitives.MixProject do
  use Mix.Project

  def project do
    [
      app: :process_primitives,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `test/process_primitives_test.exs`
...
defmodule ProcessPrimitivesTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ProcessPrimitives.run(:noop) == :ok
    end
  end
end
```
