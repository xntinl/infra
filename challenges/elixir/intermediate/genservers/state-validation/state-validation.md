...
```elixir
defmodule ValidatedStateGs.MixProject do
  use Mix.Project

  def project do
    [
      app: :validated_state_gs,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `test/validated_state_gs_test.exs`
...
defmodule ValidatedStateGsTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ValidatedStateGs.run(:noop) == :ok
    end
  end
end
```
