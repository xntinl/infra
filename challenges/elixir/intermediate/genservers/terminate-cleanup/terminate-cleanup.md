...
```elixir
defmodule TerminateCleanupGs.MixProject do
  use Mix.Project

  def project do
    [
      app: :terminate_cleanup_gs,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `test/terminate_cleanup_gs_test.exs`
...
defmodule TerminateCleanupGsTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert TerminateCleanupGs.run(:noop) == :ok
    end
  end
end
```
