...
```elixir
defmodule StopReasonsGs.MixProject do
  use Mix.Project
...
### `lib/stop_reasons_gs/supervisor.ex`
...
defmodule StopReasonsGsTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert StopReasonsGs.run(:noop) == :ok
    end
  end
end
```
