...
defmodule MigrationsLab do
  ...
  @doc "Creates post result from attrs."
...
defmodule MigrationsLabTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert MigrationsLab.run(:noop) == :ok
    end
  end
end
```
