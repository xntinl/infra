...
## Why ecto repo transactions matters
...
defmodule TxLab do
  @moduledoc """
  Ejercicio: Ecto transactions: `Repo.transaction/1` and a first taste of `Ecto.Multi`.
  Implementa el comportamiento descrito en el enunciado, exponiendo funciones públicas documentadas y con tipos claros.
  """

  @doc """
  Entry point for the tx_lab module. Replace the body with the real
