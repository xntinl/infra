...
## Why nimbleparsec csv basico matters
...
```elixir
defmodule CsvParserNimble.MixProject do
  use Mix.Project

  def project do
    [
      app: :csv_parser_nimble,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `test/csv_parser_nimble_test.exs`
...
defmodule CsvParserNimbleTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert CsvParserNimble.run(:noop) == :ok
    end
  end
end
```
