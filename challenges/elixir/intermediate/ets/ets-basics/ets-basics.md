...
```elixir
defmodule EtsIntro.MixProject do
  use Mix.Project
...
defmodule Main do
  ...
  def main do
    IO.puts("=== EtsIntro demo ===")
    run()
    IO.puts("\nDone — demo finished without errors.")
  end

  defp run do
    # EtsIntro.open/3 requires 3 argument(s);
    # call it with real values appropriate for this exercise.
    # EtsIntro.put/3 requires 3 argument(s);
    # call it with real values appropriate for this exercise.
    :ok
  end
end
