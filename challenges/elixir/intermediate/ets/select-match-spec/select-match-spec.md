...
```elixir
defmodule SelectMsDemo.MixProject do
  use Mix.Project
...
defmodule SelectMsDemoTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert SelectMsDemo.run(:noop) == :ok
    end
  end
end
```
