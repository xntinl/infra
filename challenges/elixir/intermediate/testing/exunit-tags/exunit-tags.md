...
```elixir
defmodule ExunitTags.MixProject do
  use Mix.Project
...
### `test/exunit_tags_test.exs`

```elixir
defmodule ExunitTagsTest do
  use ExUnit.Case, async: true
