...
defmodule OpaqueTypesTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert OpaqueTypes.run(:noop) == :ok
    end
  end
end
```
