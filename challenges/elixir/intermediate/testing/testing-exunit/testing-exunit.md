...
```elixir
defmodule ExunitBasics.MixProject do
  use Mix.Project
...
defmodule Calculator do
  ...
  @doc "Returns mul result from a and b."
  ...
  @doc "Returns div result from a and b."
...
### `test/exunit_basics_test.exs`

```elixir
defmodule ExunitBasicsTest do
  use ExUnit.Case, async: true

  doctest ExunitBasics

  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ExunitBasics.run(:noop) == :ok
    end
  end
end
```
