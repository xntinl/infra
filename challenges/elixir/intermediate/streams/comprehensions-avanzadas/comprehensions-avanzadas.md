...
## Why comprehensions avanzadas matters
...
```elixir
defmodule ComprAdvanced.MixProject do
  use Mix.Project
...
defmodule ComprAdvancedTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ComprAdvanced.run(:noop) == :ok
    end
  end
end
```
