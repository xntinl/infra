...
```elixir
defmodule GenstageIntro.MixProject do
  use Mix.Project
...
### `lib/genstage_intro/producer.ex`
...
### `lib/genstage_intro/consumer.ex`
...
defmodule GenstageIntroTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert GenstageIntro.run(:noop) == :ok
    end
  end
end
```
