...
## Why agent vs genserver tradeoff matters
...
```elixir
defmodule AgentVsGs.MixProject do
  use Mix.Project
...
### `test/agent_vs_gs_test.exs`

```elixir
defmodule AgentVsGsTest do
  use ExUnit.Case, async: true
