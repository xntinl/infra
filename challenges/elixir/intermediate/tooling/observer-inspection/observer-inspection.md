...
## Why observer inspection matters
...
```elixir
defmodule ObservableApp.MixProject do
  use Mix.Project
...
### `lib/observable_app/application.ex`
...
defmodule ObservableAppTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ObservableApp.run(:noop) == :ok
    end
  end
end
```
