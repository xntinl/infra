...
defmodule AliasesDemo do
  @moduledoc """
  Reference implementation for Composing tasks with Mix aliases.
  ...
  @doc """
  Entry point for the aliases_demo module. Replace the body with the real
  implementation once you have worked through the exercise.

  ## Examples

      iex> AliasesDemo.run(:noop)
      :ok
...
defmodule AliasesDemoTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert AliasesDemo.run(:noop) == :ok
    end
  end
end
```
