...
## Why mix tasks personalizadas matters
...
```elixir
defmodule MyMixTask.MixProject do
  use Mix.Project
...
defmodule Mix.Tasks.MyMixTask.GreetTest do
  ...
  doctest Mix.Tasks.MyMixTask.Greet
...
defmodule MyMixTask do
  @moduledoc """
  Reference implementation for Custom Mix tasks with `Mix.Task`.
  ...
  @doc """
  Entry point for the my_mix_task module. Replace the body with the real
  implementation once you have worked through the exercise.

  ## Examples

      iex> MyMixTask.run(:noop)
      :ok
