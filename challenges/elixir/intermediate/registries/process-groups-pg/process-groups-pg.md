...
```elixir
defmodule PgGroupsDemo.MixProject do
  use Mix.Project
...
### `lib/pg_groups_demo/application.ex`
...
defmodule PgGroupsDemoTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert PgGroupsDemo.run(:noop) == :ok
    end
  end
end
```
