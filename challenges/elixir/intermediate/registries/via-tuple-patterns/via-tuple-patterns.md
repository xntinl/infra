...
## Why via tuple patterns matters
...
```elixir
defmodule ViaTuplePatterns.MixProject do
  use Mix.Project

  def project do
    [
      app: :via_tuple_patterns,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `lib/via_tuple_patterns/application.ex`
...
### `lib/via_tuple_patterns/worker.ex`
...
### `lib/via_tuple_patterns/ets_via.ex`
...
### `test/via_tuple_patterns_test.exs`
...
defmodule ViaTuplePatternsTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ViaTuplePatterns.run(:noop) == :ok
    end
  end
end
```
