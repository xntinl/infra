...
## Why registry vs global matters
...
```elixir
defmodule NamingCompared.MixProject do
  use Mix.Project
...
### `lib/naming_compared/counter.ex`
...
### `lib/naming_compared/application.ex`
...
defmodule NamingComparedTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert NamingCompared.run(:noop) == :ok
    end
  end
end
```
