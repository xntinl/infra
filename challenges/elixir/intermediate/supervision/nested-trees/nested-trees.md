...
```elixir
defmodule NestedTrees.MixProject do
  use Mix.Project
...
defmodule NestedTreesTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert NestedTrees.run(:noop) == :ok
    end
  end
end
```
