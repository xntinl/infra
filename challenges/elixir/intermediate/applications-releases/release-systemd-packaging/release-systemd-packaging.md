...
## Why release systemd packaging matters
...
### `lib/systemd_packaged/application.ex`
...
### `test/systemd_packaged_test.exs`
...
defmodule SystemdPackagedTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert SystemdPackaged.run(:noop) == :ok
    end
  end
end
```
