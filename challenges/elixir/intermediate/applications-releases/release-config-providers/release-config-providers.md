...
## Why release config providers matters
...
│   └── main.exs
├── test/
│   └── config_providers_demo_test.exs
└── mix.exs
```
...
```elixir
defmodule ConfigProvidersDemo.MixProject do
  use Mix.Project

  def project do
    [
      app: :config_providers_demo,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `lib/config_providers_demo/json_config_provider.ex`
...
### `lib/config_providers_demo/application.ex`
...
defmodule ConfigProvidersDemo.JsonConfigProviderTest do
  ...
  doctest ConfigProvidersDemo.JsonConfigProvider
...
### `test/config_providers_demo_test.exs`

```elixir
defmodule ConfigProvidersDemoTest do
  use ExUnit.Case, async: true

  doctest ConfigProvidersDemo

  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ConfigProvidersDemo.run(:noop) == :ok
    end
  end
end
```
