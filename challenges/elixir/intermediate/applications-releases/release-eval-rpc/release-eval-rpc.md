...
```elixir
defmodule ReleaseEvalRpc.MixProject do
  use Mix.Project
...
### `lib/release_eval_rpc/counter.ex`
...
### `lib/release_eval_rpc/application.ex`
...
### `lib/release_eval_rpc/release.ex`
...
### `test/release_eval_rpc_test.exs`
...
defmodule ReleaseEvalRpcTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert ReleaseEvalRpc.run(:noop) == :ok
    end
  end
end
```
