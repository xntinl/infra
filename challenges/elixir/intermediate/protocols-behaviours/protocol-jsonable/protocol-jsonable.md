...
```elixir
defmodule JsonableDeep.MixProject do
  use Mix.Project
...
defprotocol Jsonable do
  ...
  @doc "Returns to json result from value."
  @spec to_json(t) :: String.t()
  def to_json(value)
end
```
### `lib/jsonable/impls.ex`
...
defmodule Jsonable.Impls do
  ...
  defimpl Jsonable, for: List do
    @doc "Returns to json result from list."
    def to_json(list) do
  ...
  defimpl Jsonable, for: Map do
    ...
    @doc "Returns to json result from map."
    def to_json(map) do
      pairs =
  ...
  defimpl Jsonable, for: Any do
    ...
    @doc "Returns to json result from other."
...
defmodule JsonableDeepTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert JsonableDeep.run(:noop) == :ok
    end
  end
end
```