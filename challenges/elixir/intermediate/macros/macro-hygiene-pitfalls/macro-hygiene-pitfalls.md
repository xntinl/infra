...
## Why macro hygiene pitfalls matters
...
```elixir
defmodule HygienePitfalls.MixProject do
  use Mix.Project

  def project do
    [
      app: :hygiene_pitfalls,
      version: "0.1.0",
      elixir: "~> 1.19",
...
### `test/hygiene_pitfalls_test.exs`
...
defmodule HygienePitfallsTest do
  ...
  describe "run/1" do
    test "returns :ok for a no-op input" do
      assert HygienePitfalls.run(:noop) == :ok
    end
  end
end
```
