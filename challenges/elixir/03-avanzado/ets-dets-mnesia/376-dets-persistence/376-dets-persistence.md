...
- [`:dets` docs](https://www.erlang.org/doc/man/dets.html)
- [`rebar3` DETS usage](https://github.com/erlang/rebar3)
- [DETS file format — OTP source](https://github.com/erlang/otp/blob/master/lib/stdlib/src/dets_v9.erl)
- [SQLite vs Mnesia vs DETS — Adolfo Neto](https://dev.to/adolfont)
- [Embedded state patterns in Elixir CLI tools](https://elixir-lang.org/)
