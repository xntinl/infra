...
- [`:sys` — Erlang/OTP documentation](https://www.erlang.org/doc/man/sys.html)
- [Source of `sys.erl`](https://github.com/erlang/otp/blob/master/lib/stdlib/src/sys.erl)
- [Source of `gen_server.erl` (see `system_replace_state`)](https://github.com/erlang/otp/blob/master/lib/stdlib/src/gen_server.erl)
- [Learn You Some Erlang — "Clients and Servers" / "Building an Application With OTP"](https://learnyousomeerlang.com/building-otp-applications)
- [Fred Hebert — *Erlang in Anger*, chapter 7 "Tracing"](https://www.erlang-in-anger.com/)
- [Saša Jurić — *Elixir in Action*, 2nd ed., §10.3 on OTP internals](https://www.manning.com/books/elixir-in-action-second-edition)
- [José Valim — "Poncho projects and state surgery" (Dashbit blog archive)](https://dashbit.co/blog)
