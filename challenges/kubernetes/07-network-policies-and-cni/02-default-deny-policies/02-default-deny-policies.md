...
Continue to [7.03 Ingress Network Policies with Pod and Namespace Selectors](../03-ingress-network-policies/03-ingress-network-policies.md) to learn how to write granular ingress rules that whitelist specific sources.
