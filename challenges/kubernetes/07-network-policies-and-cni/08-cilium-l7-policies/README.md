...
Continue to [7.09 Network Policy Debugging and Troubleshooting](../09-network-policy-debugging/) to learn how to diagnose when policies are not working as expected.
