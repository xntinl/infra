...
Continue to [7.10 CNI Plugin Comparison: Calico vs Cilium vs Flannel](../10-cni-comparison/) to understand the differences between CNI plugins and their NetworkPolicy capabilities.
