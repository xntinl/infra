...
- Completion of [exercise 05 (DaemonSets with Tolerations)](../05-daemonsets-with-tolerations/05-daemonsets-with-tolerations.md)
...
Some DaemonSets need to run on control-plane nodes, which are typically tainted. In [exercise 07 (Running DaemonSets on Control Plane Nodes)](../07-daemonset-on-control-plane/07-daemonset-on-control-plane.md), you will learn the taint keys and toleration patterns needed.
