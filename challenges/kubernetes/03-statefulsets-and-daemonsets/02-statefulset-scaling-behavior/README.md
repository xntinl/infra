...
You have seen `OrderedReady` vs `Parallel` at a high level. In [exercise 03 (Ordered vs Parallel Pod Management)](../03-statefulset-ordered-vs-parallel/), you will explore the details of when each policy is appropriate and how readiness gates interact with pod management.
