...
DaemonSets support two update strategies with very different behaviors. In [exercise 06 (DaemonSet Update Strategies)](../06-daemonset-update-strategies/06-daemonset-update-strategies.md), you will compare RollingUpdate and OnDelete to understand when each is appropriate.
