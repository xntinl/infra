...
- Completion of exercises [01](../01-statefulsets-and-persistent-storage/) and [09](../09-pvc-retention-policy/)
...
You have migrated data between storage backends for a single StatefulSet. In [exercise 11 (Deploying a Distributed Database with StatefulSets)](../11-distributed-database-statefulset/), you will combine everything you have learned to deploy a real distributed database.
