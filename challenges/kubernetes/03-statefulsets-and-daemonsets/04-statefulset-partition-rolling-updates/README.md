...
- Completion of exercises [01](../01-statefulsets-and-persistent-storage/) and [03](../03-statefulset-ordered-vs-parallel/)
...
You have explored StatefulSet update strategies. In [exercise 05 (DaemonSets with Tolerations and Node Selection)](../05-daemonsets-with-tolerations/), you will shift to DaemonSets and learn how they ensure one pod per node.
