...
StatefulSet PVCs persist even after scale-down or StatefulSet deletion. In [exercise 09 (PersistentVolumeClaim Retention Policies)](../09-pvc-retention-policy/), you will learn how to control this behavior with retention policies.
