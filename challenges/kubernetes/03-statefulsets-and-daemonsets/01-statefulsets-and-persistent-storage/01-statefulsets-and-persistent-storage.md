...
StatefulSets always create pods in strict order by default, but this is not always necessary. In [exercise 02 (StatefulSet Scaling and Pod Management Policy)](../02-statefulset-scaling-behavior/02-statefulset-scaling-behavior.md), you will explore how scaling works and how `podManagementPolicy` changes the behavior.
