...
- Completion of exercises [05](../05-daemonsets-with-tolerations/05-daemonsets-with-tolerations.md) and [06](../06-daemonset-update-strategies/06-daemonset-update-strategies.md)
...
StatefulSets rely on headless Services for DNS-based pod discovery. In [exercise 08 (StatefulSet DNS and Headless Service Patterns)](../08-statefulset-headless-dns-patterns/08-statefulset-headless-dns-patterns.md), you will explore DNS resolution patterns in depth.
