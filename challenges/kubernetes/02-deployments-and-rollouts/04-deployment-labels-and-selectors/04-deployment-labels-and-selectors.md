...
- Completed [exercise 01 (Your First Deployment)](../01-your-first-deployment/01-your-first-deployment.md) and [exercise 03 (Declarative Deployment Updates)](../03-declarative-deployment-updates/03-declarative-deployment-updates.md)
...
You now understand the label-selector mechanism that connects Deployments to Pods. The next exercise covers rolling updates and rollbacks -- how Kubernetes transitions Pods from one version to another without downtime. Continue to [exercise 05 (Rolling Updates and Rollbacks)](../05-rolling-updates-and-rollbacks/05-rolling-updates-and-rollbacks.md).
