...
- Completion of [exercise 01 (Your First Deployment)](../01-your-first-deployment/01-your-first-deployment.md) and [exercise 03 (Declarative Deployment Updates)](../03-declarative-deployment-updates/03-declarative-deployment-updates.md)
...
You understand the ownership relationship between Deployments and ReplicaSets. The next exercise covers revision history management -- how to inspect, prune, and navigate through Deployment revisions. Continue to [exercise 08 (Deployment Revision History and Management)](../08-deployment-revision-history/08-deployment-revision-history.md).
