...
- Completed [exercise 01 (Your First Deployment)](../01-your-first-deployment/) or equivalent understanding of Deployments and ReplicaSets
...
You now know how to manually adjust capacity and have seen the ReplicaSet controller keep your desired count intact. In [exercise 03 (Declarative Deployment Updates)](../03-declarative-deployment-updates/), you will learn how to make changes to a Deployment's Pod template declaratively and observe how Kubernetes handles the transition.
