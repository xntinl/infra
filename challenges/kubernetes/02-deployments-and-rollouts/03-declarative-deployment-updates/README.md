...
- Completed [exercise 01 (Your First Deployment)](../01-your-first-deployment/) and [exercise 02 (Scaling and Self-Healing)](../02-scaling-and-self-healing/)
...
You now understand how declarative changes to the Pod template trigger rollouts. The next exercise focuses on the label and selector relationship between Deployments, ReplicaSets, and Pods. Continue to [exercise 04 (Deployment Labels and Selectors)](../04-deployment-labels-and-selectors/).
