...
- Completed [exercise 01-01 (Your First Pod)](../../01-pods-and-pod-design/01-your-first-pod/01-your-first-pod.md) or equivalent understanding of Pods
...
Now that you have a Deployment managing Pods, the next step is learning how to adjust the replica count up and down and observing the self-healing behavior in greater depth. Continue to [exercise 02 (Scaling and Self-Healing)](../02-scaling-and-self-healing/02-scaling-and-self-healing.md).
