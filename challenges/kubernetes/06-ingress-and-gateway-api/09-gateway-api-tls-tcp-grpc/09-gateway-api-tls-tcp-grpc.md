...
In [exercise 10 (Gateway API with Different Implementations)](../10-gateway-api-implementations/10-gateway-api-implementations.md), you will deploy a real Gateway Controller and see these routes actually routing traffic end-to-end.
