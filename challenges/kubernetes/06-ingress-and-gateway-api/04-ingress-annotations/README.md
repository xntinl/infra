...
- Completion of [exercise 03 (Ingress TLS Termination)](../03-ingress-tls-termination/)
...
Ingress has served HTTP routing well, but Gateway API offers a richer and more standardized model. In [exercise 05 (Gateway API Fundamentals)](../05-gateway-api-fundamentals/), you will learn the core Gateway API concepts: GatewayClass, Gateway, and HTTPRoute.
