...
- A running Kubernetes cluster with the nginx Ingress Controller installed (see [exercise 01](../01-ingress-controller-routing/01-ingress-controller-routing.md))
- `kubectl` installed and configured
- Completion of [exercise 01 (Ingress Controller and Routing)](../01-ingress-controller-routing/01-ingress-controller-routing.md)
...
Ingress can terminate TLS connections so your backend Services do not need to handle HTTPS. In [exercise 03 (Ingress TLS Termination)](../03-ingress-tls-termination/03-ingress-tls-termination.md), you will create TLS certificates, store them as Kubernetes Secrets, and configure Ingress to serve HTTPS.
