...
Gateway API supports more than just HTTP. In [exercise 09 (Gateway API: TLSRoute, TCPRoute, GRPCRoute)](../09-gateway-api-tls-tcp-grpc/), you will explore routing for non-HTTP protocols.
