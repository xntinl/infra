...
- Completion of [exercise 01](../01-ingress-controller-routing/) and [exercise 02](../02-ingress-host-and-path-routing/)
...
You have defined Gateway API resources with basic matching. In [exercise 06 (Gateway API: HTTPRoute Advanced Matching)](../06-gateway-api-httproute/), you will explore method-based matching, query parameter matching, and request/response header modification filters.
