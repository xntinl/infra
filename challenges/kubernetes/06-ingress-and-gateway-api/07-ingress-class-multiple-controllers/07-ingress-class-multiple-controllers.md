...
- Completion of [exercise 04 (Ingress Annotations)](../04-ingress-annotations/04-ingress-annotations.md)
...
Gateway API supports traffic splitting natively. In [exercise 08 (Gateway API Traffic Splitting and Canary)](../08-gateway-api-traffic-splitting/08-gateway-api-traffic-splitting.md), you will configure weighted backends for gradual rollouts and canary deployments.
