...
- Completion of [exercise 05 (Gateway API Fundamentals)](../05-gateway-api-fundamentals/05-gateway-api-fundamentals.md)
...
Different controllers can coexist in the same cluster. In [exercise 07 (IngressClass and Multiple Controllers)](../07-ingress-class-multiple-controllers/07-ingress-class-multiple-controllers.md), you will configure multiple Ingress Controllers and learn how IngressClass selects which controller handles each Ingress resource.
