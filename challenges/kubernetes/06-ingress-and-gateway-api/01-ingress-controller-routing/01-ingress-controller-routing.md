...
- `helm` installed (v3+)
- Completion of [05-01 (Services: ClusterIP, NodePort, LoadBalancer)](../../05-services-and-service-discovery/01-services-clusterip-nodeport-loadbalancer/01-services-clusterip-nodeport-loadbalancer.md)
...
Now that you understand basic Ingress routing, [exercise 02 (Ingress Host-Based and Path-Based Routing)](../02-ingress-host-and-path-routing/02-ingress-host-and-path-routing.md) goes deeper into routing patterns, including multiple hosts, exact vs prefix paths, and default backends.
