...
Next you will implement the App of Apps pattern for managing multiple applications from a single root: [19.05 - ArgoCD: App of Apps Pattern](../05-argocd-app-of-apps/05-argocd-app-of-apps.md).
