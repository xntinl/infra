...
Next you will dive deeper into ApplicationSet generators -- matrix, merge, cluster, and pull request generators: [19.06 - ArgoCD ApplicationSets: Generator Types](../06-argocd-applicationsets/).
