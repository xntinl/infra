...
In the next exercise you will explore ArgoCD sync policies in depth -- manual vs automated sync, sync windows, and sync waves: [19.02 - ArgoCD Sync Policies and Auto-Sync](../02-argocd-sync-policies/).
