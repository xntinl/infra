...
In the next exercise you will learn ArgoCD application management patterns including health checks, resource hooks, and ignore differences: [19.04 - ArgoCD Application Management and Health Checks](../04-argocd-application-management/).
