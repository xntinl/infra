...
Next you will learn how Flux manages Helm releases using HelmRelease and HelmRepository resources: [19.07 - Flux HelmRelease and HelmRepository](../07-flux-helmrelease/).
