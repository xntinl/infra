...
Flux must be installed (see [19.03](../03-flux-basics/03-flux-basics.md)).
...
Next you will learn ArgoCD multi-cluster deployment with remote cluster registration: [19.08 - ArgoCD Multi-Cluster Deployment](../08-argocd-multi-cluster/08-argocd-multi-cluster.md).
