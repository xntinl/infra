...
- Completion of [exercise 04](../04-service-selectors-and-endpoints/) and [exercise 05](../05-dns-and-service-discovery/)
...
In [exercise 10 (Session Affinity and Traffic Policies)](../10-session-affinity-and-traffic-policy/), you will learn how to control traffic distribution with session affinity and traffic policies that determine whether requests stick to the same backend or spread evenly.
