...
You have now covered all four Service types. In [exercise 09 (EndpointSlices)](../09-endpointslices/09-endpointslices.md), you will learn about EndpointSlices -- the scalable successor to Endpoints objects -- and how topology-aware routing optimizes traffic in multi-zone clusters.
