...
- Completion of [exercise 02](../02-clusterip-service-fundamentals/) and [exercise 04](../04-service-selectors-and-endpoints/)
...
Session affinity controls which pod handles repeat requests. In [exercise 11 (External and Internal Traffic Policy)](../11-external-traffic-policy/), you will learn how `externalTrafficPolicy` and `internalTrafficPolicy` control whether traffic is routed only to local pods or distributed cluster-wide.
