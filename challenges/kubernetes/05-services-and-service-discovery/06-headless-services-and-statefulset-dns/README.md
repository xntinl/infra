...
Services can expose multiple ports on a single ClusterIP. In [exercise 07 (Multi-Port Services)](../07-multi-port-services/), you will configure Services with multiple named ports and learn why port naming is required when a Service has more than one port.
