...
Now that you understand the three Service types, [exercise 02 (ClusterIP Service Fundamentals)](../02-clusterip-service-fundamentals/) takes a deeper look at ClusterIP -- the most commonly used type -- including how kube-proxy programs iptables rules and how virtual IPs actually work.
