...
- Completion of [exercise 01 (Services: ClusterIP, NodePort, LoadBalancer)](../01-services-clusterip-nodeport-loadbalancer/01-services-clusterip-nodeport-loadbalancer.md)
...
ClusterIP provides internal access only. In [exercise 03 (NodePort Services)](../03-nodeport-services/03-nodeport-services.md), you will learn how to expose Services externally using NodePort, including port range constraints and traffic routing behavior.
