...
- Completion of [exercise 04 (Service Selectors and Endpoint Objects)](../04-service-selectors-and-endpoints/04-service-selectors-and-endpoints.md)
...
In [exercise 08 (ExternalName Services)](../08-externalname-services/08-externalname-services.md), you will learn how to create a Service that acts as a DNS alias for an external hostname, enabling seamless migration from external to internal services.
