...
- Completion of [exercise 02 (ClusterIP Service Fundamentals)](../02-clusterip-service-fundamentals/)
...
You now understand how Services discover pods internally. In [exercise 05 (DNS and Service Discovery)](../05-dns-and-service-discovery/), you will learn how CoreDNS makes Services reachable by name, including cross-namespace resolution and the resolv.conf configuration inside pods.
