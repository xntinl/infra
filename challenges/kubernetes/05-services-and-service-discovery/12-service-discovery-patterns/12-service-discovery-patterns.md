...
- Completion of [exercise 05](../05-dns-and-service-discovery/05-dns-and-service-discovery.md) and [exercise 08](../08-externalname-services/08-externalname-services.md)
...
You have mastered Service discovery patterns at the namespace level. The insane-level [exercise 13 (Building Service Mesh Patterns Without a Mesh)](../13-service-mesh-without-mesh/13-service-mesh-without-mesh.md) challenges you to implement service mesh features using only native Kubernetes primitives.
