...
- Completion of [exercise 03](../03-nodeport-services/) and [exercise 10](../10-session-affinity-and-traffic-policy/)
...
In [exercise 12 (Cross-Namespace Service Discovery Patterns)](../12-service-discovery-patterns/), you will learn how to architect service discovery across namespaces, including delegation patterns and ExternalName proxies.
