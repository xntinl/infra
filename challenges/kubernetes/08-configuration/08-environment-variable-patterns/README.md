...
Continue to [8.09 External Secrets Operator with Cloud Providers](../09-external-secrets-operator/) to learn how to sync secrets from AWS Secrets Manager, GCP Secret Manager, and Azure Key Vault.
