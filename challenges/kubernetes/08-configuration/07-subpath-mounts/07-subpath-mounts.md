...
Continue to [8.08 Environment Variable Patterns: fieldRef, resourceFieldRef](../08-environment-variable-patterns/08-environment-variable-patterns.md) to learn how to inject pod metadata and resource limits as env vars.
