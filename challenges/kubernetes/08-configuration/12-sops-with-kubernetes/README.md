...
Continue to [8.13 Dynamic Configuration Reload Without Restarts](../13-dynamic-config-reload-system/) to build a system that reloads application configuration without pod restarts.
