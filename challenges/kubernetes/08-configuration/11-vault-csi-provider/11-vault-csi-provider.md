...
Continue to [8.12 SOPS Encryption for Kubernetes Secrets](../12-sops-with-kubernetes/12-sops-with-kubernetes.md) to learn how to encrypt Secret manifests for Git storage using Mozilla SOPS.
