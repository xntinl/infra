...
Continue to [8.11 HashiCorp Vault CSI Provider Integration](../11-vault-csi-provider/11-vault-csi-provider.md) to learn how to inject secrets directly from Vault into pods.
