...
Continue to [8.05 ConfigMap Volume Updates and Propagation](../05-configmap-volume-updates/05-configmap-volume-updates.md) to understand how Kubernetes propagates configuration changes to running pods.
