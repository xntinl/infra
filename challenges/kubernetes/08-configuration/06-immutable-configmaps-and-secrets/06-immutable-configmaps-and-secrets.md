...
Continue to [8.07 SubPath Mounts for Selective File Injection](../07-subpath-mounts/07-subpath-mounts.md) to learn how to inject individual files into existing directories.
