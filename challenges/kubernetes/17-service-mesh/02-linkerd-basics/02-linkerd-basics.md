...
Continue to [17.03 Istio Traffic Management](../03-istio-traffic-management/03-istio-traffic-management.md)
to learn about VirtualService and DestinationRule for fine-grained traffic
control, or jump to [17.10 Linkerd Traffic Splitting](../10-linkerd-traffic-splitting/10-linkerd-traffic-splitting.md)
