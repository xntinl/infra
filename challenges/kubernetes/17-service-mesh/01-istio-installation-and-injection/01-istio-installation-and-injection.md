...
Continue to [17.02 Linkerd Installation and Meshing](../02-linkerd-basics/02-linkerd-basics.md) to
see a lighter-weight alternative to Istio, or jump to
[17.03 Istio Traffic Management](../03-istio-traffic-management/03-istio-traffic-management.md) to start
