...
Node selectors handle simple cases. The next exercise takes a deeper look at taints and tolerations -- the mechanism that lets you *repel* pods from specific nodes: [15.03 - Taints and Tolerations Deep Dive](../03-taints-and-tolerations/).
