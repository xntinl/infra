...
Pod affinity and anti-affinity give you powerful placement control, but they can be complex. The next exercise covers `topologySpreadConstraints` -- a more declarative and Kubernetes-native way to distribute pods evenly: [15.05 - Topology Spread Constraints](../05-topology-spread-constraints/05-topology-spread-constraints.md).
