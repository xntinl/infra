...
Now that you understand affinity and taints, the next exercise focuses specifically on `nodeSelector` -- the simplest and most common placement mechanism: [15.02 - Node Selectors and Labels](../02-node-selectors/02-node-selectors.md).
