...
You have mastered node-level scheduling. The next exercise moves to pod-level scheduling with pod affinity and anti-affinity rules that co-locate or separate pods: [15.04 - Pod Affinity and Anti-Affinity](../04-pod-affinity-anti-affinity/).
