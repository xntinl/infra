...
You have mastered day-to-day node operations. The next exercise goes deeper into the scheduler itself, exploring scheduler profiles and plugin configuration: [15.07 - Scheduler Profiles and Plugins](../07-scheduler-profiles/).
