...
Scheduler profiles let you customize the built-in scheduler. The next exercise goes further by deploying a completely separate custom scheduler alongside the default: [15.08 - Custom Schedulers: Deploying a Second Scheduler](../08-custom-schedulers/).
