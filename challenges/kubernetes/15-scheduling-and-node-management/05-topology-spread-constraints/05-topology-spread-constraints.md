...
Scheduling gets pods onto nodes, but nodes need maintenance. The next exercise covers the operational side -- cordoning, draining, and uncordoning nodes safely: [15.06 - Node Maintenance: cordon, drain, uncordon](../06-node-maintenance-cordon-drain/06-node-maintenance-cordon-drain.md).
