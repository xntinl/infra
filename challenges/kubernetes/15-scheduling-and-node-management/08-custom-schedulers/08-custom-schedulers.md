...
You can now customize how pods are placed on nodes. The next exercise shifts focus to the nodes themselves, configuring the kubelet for resource reservations and eviction thresholds: [15.09 - Kubelet Configuration and Resource Reservations](../09-kubelet-configuration/09-kubelet-configuration.md).
