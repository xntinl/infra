...
Jobs run on demand, but CronJobs run on schedules. In [exercise 03 (CronJob Schedules and Concurrency Policies)](../03-cronjob-schedules-and-policies/), you will explore schedule syntax in depth and test all three concurrency policies.
