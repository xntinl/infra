...
Jobs can fail, and how Kubernetes handles those failures matters. In [exercise 05 (Job Failure Handling)](../05-job-failure-handling/), you will explore `backoffLimit`, `activeDeadlineSeconds`, and what happens when Jobs exhaust their retries.
