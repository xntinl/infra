...
- Completion of exercises [01](../01-jobs-and-cronjobs/01-jobs-and-cronjobs.md) and [05](../05-job-failure-handling/05-job-failure-handling.md)
...
Kubernetes 1.26 introduced Pod Failure Policies, which give fine-grained control over how Jobs respond to specific failure types. In [exercise 08 (Pod Failure Policy for Jobs)](../08-job-pod-failure-policy/08-job-pod-failure-policy.md), you will learn how to distinguish between retriable and non-retriable errors.
