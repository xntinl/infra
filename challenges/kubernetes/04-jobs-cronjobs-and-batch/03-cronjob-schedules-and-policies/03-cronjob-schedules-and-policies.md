...
Standard Jobs assign random work to each pod. In [exercise 04 (Indexed Jobs for Work Queues)](../04-indexed-jobs/04-indexed-jobs.md), you will learn how Indexed Jobs assign a specific index to each pod, enabling partitioned processing.
