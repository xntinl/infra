...
- Completion of exercises [02](../02-parallel-jobs-completions/), [04](../04-indexed-jobs/), and [05](../05-job-failure-handling/)
...
This pipeline runs on a single node due to ReadWriteOnce PVC constraints. In [exercise 10 (Distributed Batch Processing with Work Queues)](../10-distributed-batch-system/), you will build a distributed batch system using message-based coordination instead of shared storage.
