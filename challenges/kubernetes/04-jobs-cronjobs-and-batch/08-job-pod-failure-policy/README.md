...
- Completion of [exercise 05 (Job Failure Handling)](../05-job-failure-handling/)
...
Individual Jobs process discrete work items, but real-world batch systems chain multiple Jobs together. In [exercise 09 (Building a Batch Processing Pipeline)](../09-batch-processing-pipeline/), you will build a multi-stage batch pipeline.
