...
CronJobs manage the lifecycle of scheduled Jobs, but sometimes you need to pause them or control their history. In [exercise 06 (CronJob Suspend, Resume, and History Limits)](../06-cronjob-suspend-and-history/06-cronjob-suspend-and-history.md), you will learn how to manage CronJob lifecycle.
