...
- Completion of [exercise 01 (Your First Pod)](../01-your-first-pod/) and [exercise 03 (Labels, Selectors, and Annotations)](../03-labels-selectors-and-annotations/)
...
You have now completed all five intermediate exercises. The next exercise introduces native sidecar containers (KEP-753), a Kubernetes 1.28+ feature that provides first-class sidecar lifecycle management. Continue to [exercise 11 (Native Sidecar Containers)](../11-native-sidecar-containers/).
