...
- Completion of [exercise 01](../01-your-first-pod/01-your-first-pod.md) and [exercise 05](../05-declarative-vs-imperative/05-declarative-vs-imperative.md)
...
In the next exercise, you will dive deeper into init containers and learn how to use them for sophisticated pre-flight checks and dependency gating. Continue to [exercise 07 (Init Containers for Pre-Flight Checks)](../07-init-containers/07-init-containers.md).
