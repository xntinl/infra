...
- Completion of exercises [06](../06-multi-container-patterns/06-multi-container-patterns.md), [07](../07-init-containers/07-init-containers.md), [09](../09-pod-lifecycle-hooks/09-pod-lifecycle-hooks.md), and [11](../11-native-sidecar-containers/11-native-sidecar-containers.md)
