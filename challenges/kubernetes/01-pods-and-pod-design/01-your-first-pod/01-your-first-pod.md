...
Now that you understand Pods, the next step is learning how Pod lifecycle phases and restart policies determine what happens when containers exit. Continue to [exercise 02 (Pod Lifecycle and Restart Policies)](../02-pod-lifecycle-and-restart-policies/02-pod-lifecycle-and-restart-policies.md).
