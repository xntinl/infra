...
- Completion of [exercise 02 (Pod Lifecycle and Restart Policies)](../02-pod-lifecycle-and-restart-policies/02-pod-lifecycle-and-restart-policies.md) and [exercise 07 (Init Containers)](../07-init-containers/07-init-containers.md)
