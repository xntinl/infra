...
- Completion of [exercise 06 (Multi-Container Patterns)](../06-multi-container-patterns/06-multi-container-patterns.md), [exercise 07 (Init Containers)](../07-init-containers/07-init-containers.md), and [exercise 08 (Ephemeral Containers)](../08-ephemeral-containers-and-debugging/08-ephemeral-containers-and-debugging.md)
