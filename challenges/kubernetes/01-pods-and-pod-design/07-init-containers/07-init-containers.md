...
- Completion of [exercise 01 (Your First Pod)](../01-your-first-pod/01-your-first-pod.md) and [exercise 06 (Multi-Container Patterns)](../06-multi-container-patterns/06-multi-container-patterns.md)
...
Init containers handle pre-startup logic, but sometimes you need to debug a running Pod without modifying its spec. In the next exercise, you will learn about ephemeral containers and `kubectl debug`. Continue to [exercise 08 (Ephemeral Containers and kubectl debug)](../08-ephemeral-containers-and-debugging/08-ephemeral-containers-and-debugging.md).
