...
- Completion of [exercise 06 (Multi-Container Patterns)](../06-multi-container-patterns/06-multi-container-patterns.md) and [exercise 07 (Init Containers)](../07-init-containers/07-init-containers.md)
