...
You now understand how namespaces organize resources and provide scope. The next exercise covers the differences between imperative and declarative resource management in depth. Continue to [exercise 05 (Declarative vs Imperative Management)](../05-declarative-vs-imperative/05-declarative-vs-imperative.md).
