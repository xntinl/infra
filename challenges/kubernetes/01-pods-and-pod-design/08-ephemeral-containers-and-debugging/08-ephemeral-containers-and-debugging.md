...
- Completion of [exercise 01 (Your First Pod)](../01-your-first-pod/01-your-first-pod.md) and [exercise 07 (Init Containers)](../07-init-containers/07-init-containers.md)
...
You have learned how to debug running Pods without modifying their spec. The next exercise covers Pod lifecycle hooks -- `postStart` and `preStop` -- which let you run commands at container startup and shutdown. Continue to [exercise 09 (Pod Lifecycle Hooks)](../09-pod-lifecycle-hooks/09-pod-lifecycle-hooks.md).
