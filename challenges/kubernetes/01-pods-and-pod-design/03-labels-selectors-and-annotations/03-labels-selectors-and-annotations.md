...
- Completed [exercise 01 (Your First Pod)](../01-your-first-pod/01-your-first-pod.md) and [exercise 02 (Pod Lifecycle and Restart Policies)](../02-pod-lifecycle-and-restart-policies/02-pod-lifecycle-and-restart-policies.md)
...
Now that you understand how to organize resources with labels and annotations, the next exercise introduces namespaces -- the mechanism for isolating groups of resources within a single cluster. Continue to [exercise 04 (Working with Namespaces)](../04-working-with-namespaces/04-working-with-namespaces.md).
