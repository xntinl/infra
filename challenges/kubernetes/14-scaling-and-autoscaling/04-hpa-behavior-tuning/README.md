...
Next, you will move beyond CPU and memory to scale based on custom application metrics from Prometheus: [14.05 - HPA with Custom Metrics from Prometheus](../05-hpa-custom-metrics/).
