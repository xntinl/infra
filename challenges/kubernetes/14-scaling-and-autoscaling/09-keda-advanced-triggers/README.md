...
Scaling pods is only half the story. The next exercise covers scaling the cluster itself -- adding and removing nodes to match workload demand: [14.10 - Cluster Autoscaler: Node Scaling](../10-cluster-autoscaler/).
