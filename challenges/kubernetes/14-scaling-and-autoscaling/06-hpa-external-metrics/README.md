...
You have seen horizontal scaling from resource, custom, and external metrics. The next exercise covers **vertical** scaling -- automatically adjusting pod resource requests with the Vertical Pod Autoscaler: [14.07 - Vertical Pod Autoscaler (VPA)](../07-vertical-pod-autoscaler/).
