...
You now understand the basics of manual and automatic scaling. The next exercise dives into HPA behavior tuning -- configuring scale-up and scale-down policies for production workloads: [14.04 - HPA Behavior: Scale-Up and Scale-Down Policies](../04-hpa-behavior-tuning/04-hpa-behavior-tuning.md).
