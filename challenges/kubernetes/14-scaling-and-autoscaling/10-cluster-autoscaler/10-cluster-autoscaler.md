...
Cluster Autoscaler works but can be slow (minutes to provision nodes). The next exercise covers Karpenter, which provisions right-sized nodes directly without ASG intermediaries: [14.11 - Karpenter: Intelligent Node Provisioning](../11-karpenter/11-karpenter.md).
