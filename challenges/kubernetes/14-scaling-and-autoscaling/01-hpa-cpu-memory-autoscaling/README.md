...
In the next exercise you will explore HPA target utilization types in more detail -- `Utilization` vs `AverageValue` vs `Value` -- and learn how the HPA algorithm calculates desired replicas: [14.02 - HPA Basics and Target Utilization](../02-hpa-basics-target-utilization/).
