...
Now that you understand how the HPA calculates replicas, the next exercise covers basic manual scaling patterns using `kubectl scale` and declarative replica management: [14.03 - Manual Scaling: replicas, kubectl scale](../03-manual-scaling-patterns/).
