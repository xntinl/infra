...
Next you will explore Kustomize components and the replacements transformer for advanced reuse patterns: [18.07 - Kustomize Components and Replacements](../07-kustomize-components-and-replacements/).
