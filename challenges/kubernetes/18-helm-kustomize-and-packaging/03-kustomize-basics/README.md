...
In the next exercise you will learn how Helm manages complex dependency trees using subcharts: [18.04 - Helm Subcharts and Dependencies](../04-helm-subcharts-and-dependencies/).
