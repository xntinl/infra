...
In the next exercise you will learn Kustomize -- a template-free approach to customizing Kubernetes manifests using base directories and overlays: [18.03 - Kustomize Basics: Base and Overlays](../03-kustomize-basics/).
