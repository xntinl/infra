...
Next you will learn how to write and run automated tests for Helm charts: [18.08 - Helm Chart Testing with ct and helm test](../08-helm-testing/08-helm-testing.md).
