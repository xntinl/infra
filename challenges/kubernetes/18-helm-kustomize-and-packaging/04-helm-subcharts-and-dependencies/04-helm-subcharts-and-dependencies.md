...
Next you will revisit Kustomize with deeper multi-environment overlay patterns including configMapGenerator, secretGenerator, and image transformers: [18.05 - Kustomize Overlays for Multi-Environment](../05-kustomize-overlays/05-kustomize-overlays.md).
