...
In the next exercise you will dive into Helm's Go template language -- named templates, control flow, functions, and per-environment value overrides: [18.02 - Helm Values and Templates](../02-helm-values-and-templates/02-helm-values-and-templates.md).
