...
- `helm` installed
- Completion of exercises [01](../01-resource-requests-and-limits/01-resource-requests-and-limits.md), [02](../02-qos-classes/02-qos-classes.md), [03](../03-limitranges/03-limitranges.md), [04](../04-resource-quotas/04-resource-quotas.md), and [06](../06-resource-right-sizing/06-resource-right-sizing.md)
...
You now have the skills to monitor and optimize individual workloads. The final exercise challenges you to build a comprehensive multi-tenant resource governance platform. Continue to [exercise 10 (Multi-Tenant Resource Governance Platform)](../10-multi-tenant-resource-governance/10-multi-tenant-resource-governance.md).
