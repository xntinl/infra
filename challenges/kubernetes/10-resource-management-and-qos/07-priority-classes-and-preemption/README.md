...
Priority Classes control scheduling order. The next exercise covers Pod Overhead and Runtime Classes, which account for the resource cost of the container runtime itself. Continue to [exercise 08 (Pod Overhead and Runtime Classes)](../08-pod-overhead-and-runtime-classes/).
