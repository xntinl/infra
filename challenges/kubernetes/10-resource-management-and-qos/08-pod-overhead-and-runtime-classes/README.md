...
- Completion of [exercise 01](../01-resource-requests-and-limits/), [exercise 02](../02-qos-classes/), and [exercise 07](../07-priority-classes-and-preemption/)
...
Now that you understand runtime overhead, the next exercise covers building a comprehensive resource monitoring and optimization workflow. Continue to [exercise 09 (Resource Monitoring and Optimization Workflow)](../09-resource-monitoring-and-optimization/).
