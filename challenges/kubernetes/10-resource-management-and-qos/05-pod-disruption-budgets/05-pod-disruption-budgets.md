...
PDBs protect against voluntary disruptions. The next exercise covers right-sizing resources using VPA recommendations. Continue to [exercise 06 (Resource Right-Sizing with VPA Recommendations)](../06-resource-right-sizing/06-resource-right-sizing.md).
