...
- Completion of [exercise 01](../01-resource-requests-and-limits/) and [exercise 03](../03-limitranges/)
...
ResourceQuotas and LimitRanges protect the cluster, but disruptions during maintenance can still take down applications. The next exercise covers Pod Disruption Budgets. Continue to [exercise 05 (Pod Disruption Budgets)](../05-pod-disruption-budgets/).
