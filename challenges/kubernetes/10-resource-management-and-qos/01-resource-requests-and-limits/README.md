...
Now that you understand requests and limits, the next exercise explores the three QoS classes that Kubernetes automatically assigns based on resource configuration. Continue to [exercise 02 (QoS Classes: Guaranteed, Burstable, BestEffort)](../02-qos-classes/).
