...
Now that you can right-size resources, the next exercise covers Priority Classes and how Kubernetes preempts lower-priority pods for critical workloads. Continue to [exercise 07 (Priority Classes and Preemption)](../07-priority-classes-and-preemption/07-priority-classes-and-preemption.md).
