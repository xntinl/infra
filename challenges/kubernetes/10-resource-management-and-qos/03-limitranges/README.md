...
LimitRanges control per-container and per-pod resources. The next exercise covers ResourceQuotas, which control total resource consumption across an entire namespace. Continue to [exercise 04 (ResourceQuotas: CPU, Memory, and Object Count)](../04-resource-quotas/).
