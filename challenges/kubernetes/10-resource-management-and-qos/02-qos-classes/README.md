...
Now that you understand QoS classes, the next exercise covers LimitRanges, which set default and constrained resource values at the namespace level. Continue to [exercise 03 (LimitRanges: Default and Constraints Per Namespace)](../03-limitranges/).
