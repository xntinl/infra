...
- Completion of exercises [01](../01-persistent-volumes-and-claims/), [02](../02-storage-classes-dynamic-provisioning/), and [05](../05-pvc-access-modes-and-binding/)
...
Now that you understand shared storage, the next exercise covers full namespace backup and restore using Velero. Continue to [exercise 11 (Namespace Backup and Restore with Velero)](../11-velero-backup-restore/).
