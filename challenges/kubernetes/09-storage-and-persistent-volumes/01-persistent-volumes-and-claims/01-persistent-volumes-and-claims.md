...
Now that you understand manual PV provisioning, the next exercise covers StorageClasses and dynamic provisioning, where Kubernetes creates PVs automatically. Continue to [exercise 02 (Storage Classes and Dynamic Provisioning)](../02-storage-classes-dynamic-provisioning/02-storage-classes-dynamic-provisioning.md).
