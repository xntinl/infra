...
- Completion of exercises [01](../01-persistent-volumes-and-claims/), [02](../02-storage-classes-dynamic-provisioning/), and [07](../07-volume-snapshots/)
...
Now that you can clone and migrate volumes, the next exercise covers shared storage patterns with ReadWriteMany access. Continue to [exercise 10 (ReadWriteMany Shared Storage Patterns)](../10-rwx-shared-storage/).
