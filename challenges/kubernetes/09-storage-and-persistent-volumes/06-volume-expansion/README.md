...
Now that you can resize volumes, the next exercise covers creating point-in-time snapshots for backup and cloning. Continue to [exercise 07 (Volume Snapshots and Restore)](../07-volume-snapshots/).
