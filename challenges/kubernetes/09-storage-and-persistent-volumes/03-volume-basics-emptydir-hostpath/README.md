...
You now understand the basic volume types. Next, explore how projected volumes combine multiple data sources into a single mount point. Continue to [exercise 04 (Ephemeral Volumes: emptyDir and Projected)](../04-ephemeral-volumes-emptydir-projected/).
