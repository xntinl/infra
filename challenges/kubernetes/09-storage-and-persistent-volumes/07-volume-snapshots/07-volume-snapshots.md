...
Now that you can snapshot and restore volumes, the next exercise covers CSI drivers and how to use different storage backends. Continue to [exercise 08 (CSI Drivers: EBS, EFS, Local Path)](../08-csi-drivers/08-csi-drivers.md).
